  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if int(params.get('LateralControlMethod')) == 0:
      if candidate == CAR.SANTAFE:
        ...
        ret.wheelbase = 2.80
        ret.steerRatio = 16.5   # 15% higher at the center seems reasonable
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0.], [0.]]
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.25], [0.05]]
        ...
        ret.mass = 1275. + STD_CARGO_KG
        ret.wheelbase = 2.7
        ret.steerRatio = 16.5           # 14 is Stock | Settled Params Learner values are steerRatio: 15.401566348670535
        ret.lateralTuning.pid.kiBP, ret.lateralTuning.pid.kpBP = [[0.], [0.]]
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.25], [0.05]]
